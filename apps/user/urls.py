...
from .views import VerifyAccountCodeNumber, ResendVerificationCode, SendResetPasswordCode, ResetPassword, UserViewSet, CreateUserAdminAccountView, ActiveAccountAdminView, VerifyResetPasswordCode
...
urlpatterns = [
    ...
    path('auth/verify-reset-password-code/', VerifyResetPasswordCode.as_view()),
